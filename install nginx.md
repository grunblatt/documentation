...
server {
    if ($host = devapi.srx365.sprxdev.com) {
...
[Service]
WorkingDirectory=/var/www/devapi.srx365.sprxdev.com
ExecStart=/usr/bin/dotnet /var/www/devapi.srx365.sprxdev.com/SRX365_API/bin/Debug/net6.0/publish/PocPostgresApi.dll
Restart=always
RestartSec=10
SyslogIdentifier=SRX365_API
User=root
